...
function [retCost, retPos, OptCost] = Function_BA1(n, MaxIt, lb,ub,dim,fobj)
%% Problem Definition
...
for it = 1:MaxIt
    ...
    % disp(['Iteration ' num2str(it) ': Best Cost = ' num2str(OptCost(it)) '; Fittness Evaluations = ' num2str(Counter(it)) '; Time  = ' num2str(Time)]);
